...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		*@param ptree xml file  
		*@param target solid material index (from 1 to the number of materials)
		*/
		KineticsMap_Solid_CHEMKIN(ThermodynamicsMap_Solid_CHEMKIN& thermo, boost::property_tree::ptree& ptree, const unsigned int target);
		...
		*/
		KineticsMap_Solid_CHEMKIN(ThermodynamicsMap_Solid_CHEMKIN& thermo, boost::property_tree::ptree& ptree, const std::string target);
