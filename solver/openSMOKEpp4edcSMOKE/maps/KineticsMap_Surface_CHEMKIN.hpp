			...
			if( node.first == "MaterialKinetics" ) 
			{
				if (target_material == subtree.get<unsigned int>("<xmlattr>.index") )
				{
					...
					// Stick reactions
					{
						...
						number_of_stick_reactions_ = static_cast<unsigned int>(indices_of_stick_reactions__.size());
					}
					...
					// Cov dependent reactions
					{
						...
						number_of_coverage_dependent_reactions_ = static_cast<unsigned int>(indices_of_coverage_dependent_reactions__.size());
					}
					...
					// Langmuir-Hinshelwood reactions
					{
						...
						number_of_langmuir_reactions_ = static_cast<unsigned int>(indices_of_langmuir_reactions__.size());
					}
					...
					// Lumped reactions
					{
						...
						number_of_lumped_reactions_ = static_cast<unsigned int>(indices_of_lumped_reactions__.size());
					}
