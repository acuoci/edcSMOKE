...
#ifndef NlsKernelTridiagonalBlock_H
#define NlsKernelTridiagonalBlock_H
...
namespace NlsSMOKE
{
	//!  A class to manage TridiagonalBlock Jacobian matrices associated to NLS systems
	/*!
	A class to manage TridiagonalBlock Jacobian matrices associated to NLS systems
	*/

	template <typename NLSSystemObject>
	class KernelTridiagonalBlock : public NLSSystemObject
	{
	public:
		...
		*/
		...
		/**
		*@brief Function to set the TridiagonalBlock dimension
		*@param blockSize block size
		*/
		void SetTridiagonalBlockSize(const unsigned int blockSize);

		/**
		*@brief Function to set the solver for the solution of the TridiagonalBlock linear system
	...
	private:
		...
		Eigen::VectorXd df_over_dx_;

		OpenSMOKE::OpenSMOKETridiagonalBlockMatrixDouble* J_;				//!< TridiagonalBlock matrix (unfactorized)
		OpenSMOKE::OpenSMOKETridiagonalBlockMatrixDouble* J_factorized_;	//!< TridiagonalBlock matrix (factorized version)
