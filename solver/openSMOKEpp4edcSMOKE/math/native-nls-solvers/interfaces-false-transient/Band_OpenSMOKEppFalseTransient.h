...
#ifndef OpenSMOKE_Solve_Band_OpenSMOKEppFalseTransient_H
#define OpenSMOKE_Solve_Band_OpenSMOKEppFalseTransient_H
...
namespace NlsSMOKE
{
	...
	int Solve_Band_OpenSMOKEppFalseTransient(Object* object, const NlsSMOKE::FalseTransientSolver_Parameters& parameters)
	{
		std::cout << "Band False Transient solution (OpenSMOKE++)..." << std::endl;
...
#endif // OpenSMOKE_Solve_Band_OpenSMOKEppFalseTransient_H
