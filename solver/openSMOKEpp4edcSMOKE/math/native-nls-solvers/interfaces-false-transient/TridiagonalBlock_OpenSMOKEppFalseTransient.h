...
#ifndef OpenSMOKE_Solve_TridiagonalBlock_OpenSMOKEppFalseTransient_H
#define OpenSMOKE_Solve_TridiagonalBlock_OpenSMOKEppFalseTransient_H
...
namespace NlsSMOKE
{
	...
	int Solve_TridiagonalBlock_OpenSMOKEppFalseTransient(Object* object, const NlsSMOKE::FalseTransientSolver_Parameters& parameters)
	{
		std::cout << "TridiagonalBlock False Transient solution (OpenSMOKE++)..." << std::endl;
		...
		typedef NlsSMOKE::KernelTridiagonalBlock<System> kernel;
		...
		nls_solver.SetTridiagonalBlockSize(object->BlockDimensions());
...
#endif // OpenSMOKE_Solve_TridiagonalBlock_OpenSMOKEppFalseTransient_H
