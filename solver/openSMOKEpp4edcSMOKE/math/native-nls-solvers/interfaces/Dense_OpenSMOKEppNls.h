...
#ifndef OpenSMOKE_Solve_Dense_OpenSMOKEppNls_H
#define OpenSMOKE_Solve_Dense_OpenSMOKEppNls_H
...
namespace NlsSMOKE
{
	...
	int Solve_Dense_OpenSMOKEppNls(	Object* object, const NlsSMOKE::NonLinearSolver_Parameters& parameters,
									const double t, Eigen::VectorXd& y, Eigen::VectorXd& f )
	{
		...
		typedef NlsSMOKE::KernelDense<System> kernel;
...
#endif // OpenSMOKE_Solve_Dense_OpenSMOKEppNls_H
