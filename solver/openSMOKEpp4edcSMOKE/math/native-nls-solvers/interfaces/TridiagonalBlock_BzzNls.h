...
#ifndef OpenSMOKE_Solve_TridiagonalBlock_BzzNls_H
#define OpenSMOKE_Solve_TridiagonalBlock_BzzNls_H
...
namespace NlsSMOKE
{
	...
	int Solve_TridiagonalBlock_BzzNls(Object* object, BzzNonLinearSystemSparseObject& nls_object, const NlsSMOKE::NonLinearSolver_Parameters& parameters)
	{
		std::cout << "TridiagonalBlock NLS solution (BzzNls)..." << std::endl;
		...
		nls_object(yInitial, &nls_system, object->BlockDimensions());
...
#endif // OpenSMOKE_Solve_TridiagonalBlock_BzzNls_H
