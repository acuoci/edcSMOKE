...
#ifndef OpenSMOKE_Solve_TridiagonalBlock_OpenSMOKEppNls_H
#define OpenSMOKE_Solve_TridiagonalBlock_OpenSMOKEppNls_H
...
namespace NlsSMOKE
{
	...
	int Solve_TridiagonalBlock_OpenSMOKEppNls(Object* object, const NlsSMOKE::NonLinearSolver_Parameters& parameters)
	{
		std::cout << "TridiagonalBlock NLS solution (OpenSMOKE++)..." << std::endl;
...
#endif // OpenSMOKE_Solve_TridiagonalBlock_OpenSMOKEppNls_H
