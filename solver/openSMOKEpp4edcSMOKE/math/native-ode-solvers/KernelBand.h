...
#ifndef OdeKernelBand_H
#define OdeKernelBand_H
...
namespace OdeSMOKE
{
	...
	*/
	...
	class KernelBand : public ODESystemObject
	{
	public:
	...
	private:
		...
		OpenSMOKE::OpenSMOKEBandMatrixDouble* J_;
		OpenSMOKE::OpenSMOKEBandMatrixDouble* G_;
	};
}
