...
#ifndef OpenSMOKE_Solve_TridiagonalBlock_OpenSMOKEppOde_H
#define OpenSMOKE_Solve_TridiagonalBlock_OpenSMOKEppOde_H
...
namespace OdeSMOKE
{
	...
	int Solve_TridiagonalBlock_OpenSMOKEppOde(Object* object, const OdeSMOKE::OdeSolver_Parameters& parameters, const double t0, const double tEnd)
	{
		std::cout << "TridiagonalBlock ODE solution (OpenSMOKE++)..." << std::endl;
		...
		typedef OdeSMOKE::KernelTridiagonalBlock<System> TridiagonalBlockOde;
		typedef OdeSMOKE::MethodGear<TridiagonalBlockOde> methodGear;
		OdeSMOKE::MultiValueSolver<methodGear> ode_solver;

		// Set initial conditions
		ode_solver.assign(object);
		ode_solver.SetInitialConditions(t0, yInitial);
		ode_solver.SetTridiagonalBlockSize(object->BlockDimensions());
...
#endif // OpenSMOKE_Solve_TridiagonalBlock_OpenSMOKEppOde_H
