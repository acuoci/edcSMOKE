...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		*@return the vector containing the list of reactions
		*/
		vector_reactions& reactions() { return all_reactions_; }
	...
	protected:
		...
		vector_reactions all_reactions_;						//!< list of all reaction lines in all materials
		std::vector<unsigned int>  all_reaction_lines;			//!< list of all lines referring to a reaction   
