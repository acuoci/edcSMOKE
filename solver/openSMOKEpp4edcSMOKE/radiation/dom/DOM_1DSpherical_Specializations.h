...
#ifndef OpenSMOKE_DOM_1DSpherical_Specializations_H
#define	OpenSMOKE_DOM_1DSpherical_Specializations_H
...
namespace OpenSMOKE
{
	...
	*/
	...
	class DOM_1DSpherical_S2sym : public DOM_1DSpherical
	{

	public:

		DOM_1DSpherical_S2sym(Grid1DMultiPurpose* grid) : 
			DOM_1DSpherical(grid)
		{
			n_ = 2;
			N_ = 1;
	...
	*/
	...
	class DOM_1DSpherical_S2nonsym : public DOM_1DSpherical
	{

	public:

		DOM_1DSpherical_S2nonsym(Grid1DMultiPurpose* grid) :
			DOM_1DSpherical(grid)
		{
			n_ = 2;
			N_ = 1;
	...
	*/
	...
	class DOM_1DSpherical_S4 : public DOM_1DSpherical
	{

	public:

		DOM_1DSpherical_S4(Grid1DMultiPurpose* grid) :
			DOM_1DSpherical(grid)
		{
			n_ = 4;
			N_ = 2;
	...
	*/
	...
	class DOM_1DSpherical_S6 : public DOM_1DSpherical
	{

	public:

		DOM_1DSpherical_S6(Grid1DMultiPurpose* grid) :
			DOM_1DSpherical(grid)
		{
			n_ = 6;
			N_ = 3;
	...
	*/
	...
	class DOM_1DSpherical_S8 : public DOM_1DSpherical
	{

	public:

		DOM_1DSpherical_S8(Grid1DMultiPurpose* grid) :
			DOM_1DSpherical(grid)
		{
			n_ = 8;
			N_ = 4;
	...
	*/
	...
	class DOM_1DSpherical_S10 : public DOM_1DSpherical
	{

	public:

		DOM_1DSpherical_S10(Grid1DMultiPurpose* grid) :
			DOM_1DSpherical(grid)
		{
			n_ = 10;
			N_ = 5;
	...
	*/
	...
	class DOM_1DSpherical_S12 : public DOM_1DSpherical
	{

	public:

		DOM_1DSpherical_S12(Grid1DMultiPurpose* grid) :
			DOM_1DSpherical(grid)
		{
			n_ = 12;
			N_ = 6;
	...
	*/
	...
	class DOM_1DSpherical_S16 : public DOM_1DSpherical
	{

	public:

		DOM_1DSpherical_S16(Grid1DMultiPurpose* grid) :
			DOM_1DSpherical(grid)
		{
			n_ = 16;
			N_ = 8;
