...
#ifndef OpenSMOKE_OnTheFlyPostProcessing_Liquid_H
#define	OpenSMOKE_OnTheFlyPostProcessing_Liquid_H
...
namespace OpenSMOKE
{
	...
	*/
	...
	class OnTheFlyPostProcessing_Liquid
	{
	public:
		...
		*/
		OnTheFlyPostProcessing_Liquid(OpenSMOKE::ThermodynamicsMap_Liquid_CHEMKIN& thermodynamicsMap,
		...
		*/
		void WriteOnFile(const double t, const double x, const double y, const double z, const double T, const double P_Pa, 
	...
	private:
		...
		OpenSMOKE::ThermodynamicsMap_Liquid_CHEMKIN&	thermodynamicsMap_;		//!< thermodynamic map
		OpenSMOKE::KineticsMap_Liquid_CHEMKIN&			kineticsMap_;			//!< kinetic map
		...
		unsigned int NS_;					//!< number of gas+liquid species		
		unsigned int NSG_;					//!< number of gas species		
		unsigned int NSL_;					//!< number of liquid species
		...
		OpenSMOKE::OpenSMOKEVectorDouble Rg_;	//!< formation rates of species [kmol/m3/s]
		OpenSMOKE::OpenSMOKEVectorDouble Rl_;	//!< formation rates of species [kmol/m3/s]
		OpenSMOKE::OpenSMOKEVectorDouble xG_;	//!< mole fractions
		OpenSMOKE::OpenSMOKEVectorDouble cGas_;	//!< concentrations [kmol/m3]
		OpenSMOKE::OpenSMOKEVectorDouble xL_;	//!< mole fractions
		OpenSMOKE::OpenSMOKEVectorDouble cLiq_;	//!< concentrations [kmol/m3]
...
#include "OnTheFlyPostProcessing_Liquid.hpp"

#endif	/* OpenSMOKE_OnTheFlyPostProcessing_Liquid_H */
