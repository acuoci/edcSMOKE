...
namespace OpenSMOKE
{
	...
	protected:
		...
		virtual void DefineRules()
		{
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@ThermophoreticEffectEuckenApproximation",
				OpenSMOKE::SINGLE_BOOL,
				"If true, the thermophoretic velocity is calculated on the basis of the Eucken approximation (default: true)",
				false));
